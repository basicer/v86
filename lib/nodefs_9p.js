    ...
    set_state(state) {
        ...
        if(Array.isArray(state[8])) {
            for(let i = 0; i < state[8].length; i++) {
                ...
                this.fids[i] = {type: type, uid: uid, path: dbgname.split("/").slice(1)};
            }
        }
    }
        ...
        switch(id)
        {
            ...
            case 70: // link
            {
                ...
                try {
                    ...
                    await this.fs.chown(dpath, this.fids[dfid].uid, this.fids[dfid].gid);
                } catch(e) {
            ...
            case 16: // symlink
            {
                ...
                try {
                    ...
                    await this.fs.chown(path, this.fids[fid].uid, gid);
                } catch(e) {
                    return this.TrnaslateErrorAndRespond(e, id, tag);
                }
