            ...
            [
                ...
                (queue_id) =>
                {
                    ...
                    while(queue.has_request())
                    {
                        ...
                        console.log(op, parts, new TextDecoder().decode(payload));
                        ...
                        if(op === 5) {
                            this.send(parts[1], parts[0], parts[3], parts[2], new TextEncoder().encode("OK!" + new TextDecoder().decode(payload)));
                        }
